...
var i = 0;
var url = "http://www.ss.pku.edu.cn/index.php/newscenter/news/3296"; //初始url
...
function savedImg($,news_title) {
    $('.article-content img').each(function (index,item) {
        ...
        if (img_title.length>15||img_title==''){
            img_title="Null";
        }
        ...
        request(img_src).pipe(fs.createWriteStream('./img/'+news_title + '---' + img_filename));     //通过流的方式，把图片写到本地/image目录下，并用新闻的标题和图片的标题作为图片的名称。
